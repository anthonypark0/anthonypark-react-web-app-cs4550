import { MdDoNotDisturbAlt, MdHome, MdCampaign, MdOutlineAnalytics } from "react-icons/md";
import { FaCheckCircle, FaEye, FaBell } from "react-icons/fa";
...
export default function CourseStatus() {
  return (
    <div id="wd-course-status" style={{ width: "350px" }}>
      ...
      <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
        <FaEye className="me-2 fs-5" /> View Course Screen
      </Button>
      <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
